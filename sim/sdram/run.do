...
virtual function {(state_type)/tb_top/top_inst/sdram_top_inst/state_c} top_state_c
virtual function {(state_type)/tb_top/top_inst/sdram_top_inst/state_n} top_state_n

virtual type { {5'b00001 WR_IDLE} {5'b00010 WR_REQ} {5'b00100 WR_ACTIVE} {5'b01000 WR_WRITE} {5'b10000 WR_BREAK} } wr_state_type
virtual function {(wr_state_type)/tb_top/top_inst/sdram_top_inst/sdram_write_inst/state_c} wr_state_c
virtual function {(wr_state_type)/tb_top/top_inst/sdram_top_inst/sdram_write_inst/state_n} wr_state_n
...
virtual function {(cmd_type)/tb_top/top_inst/sdram_top_inst/cmd} cmd_new

virtual function {(cmd_type)/tb_top/top_inst/sdram_top_inst/sdram_init_inst/init_cmd} init_cmd_new
virtual function {(cmd_type)/tb_top/top_inst/sdram_top_inst/sdram_write_inst/wr_cmd} wr_cmd_new
...
add wave tb_top/top_inst/sdram_top_inst/sdram_init_inst/*

add wave -divider {sdram_aref}
add wave tb_top/top_inst/sdram_top_inst/sdram_aref_inst/*
...
add wave tb_top/top_inst/decode_inst/*

add wave -divider {wfifo}
add wave tb_top/top_inst/wfifo_16x8_inst/*

add wave -divider {rfifo}
add wave tb_top/top_inst/rfifo_16x8_inst/*
